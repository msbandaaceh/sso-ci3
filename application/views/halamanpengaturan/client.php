...
<div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Pengaturan Akun /</span> Data Aplikasi Client
        </h4>
            ...
            <div class="col-md-12">
                <ul class="nav nav-pills flex-column flex-md-row mb-3">
                    ...
                    if (in_array($this->session->userdata("jab_id"), ['0', '5', '11'])) {
                        ?>
                        <li class="nav-item">
                            <a class="nav-link active" href="<?= site_url('plh'); ?>"><i class="bx bx-bell me-1"></i>
                                Pengaturan Plh</a>
                        </li>
                        <?php
                    }
